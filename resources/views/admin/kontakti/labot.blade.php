        ...
        <div class="col-md-10 col-sm-10 col-md-offset-1">
            ...
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3>Kontaktinformācijas labošana</h3>
                </div>
                                ...
                                <div role="tabpanel" class="tab-pane active" id="lv">
                                    ...
                                    <div class="tab-body">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-4">
                                                <!-- Darba laiks LV -->
                                                <label for="dlaiknos_lv" class="control-label">Darbalaiks</label>
                                ...
                                <div role="tabpanel" class="tab-pane" id="en">
                                    ...
                                    <div class="tab-body">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-4">
                                                <!-- Darba laiks EN -->
                                                <label for="dlaiknos_en" class="control-label">Darbalaiks</label>
                                ...
                                <div role="tabpanel" class="tab-pane" id="ru">
                                    <div class="tab-body">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-4">
                                                <!-- Darba laiks EN -->
                                                <label for="dlaiknos_ru" class="control-label">Darbalaiks</label>
