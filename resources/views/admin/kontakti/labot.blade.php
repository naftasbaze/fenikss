                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="tab-body">
                                        <!-- Nosaukums LV -->
                                            ...
                                            <input type="text" name="nosaukums" id="nosaukums" class="form-control"
                                                   value="{{ old('nosaukums', $kontakti->nosaukums_lv ) }}">
                                ...
                                <div role="tabpanel" class="tab-pane" id="en">
                                    ...
                                    <input type="text" name="title" id="title" class="form-control"
                                           value="{{ old('title', $kontakti->nosaukums_en ) }}">
                                    </div>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    ...
                                    @if ( old('publicet',$kontakti->tel2)) checked="checked" @endif>
